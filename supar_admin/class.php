              ...
              <div class="card-body">
                <form>
                  <div class="row ">
                    ...
                    <div class="col-lg-12">
                      <label class="fs-5 mb-1" for="annoucment-subject">کلاس </label>
                      <input type="text" name="annoucment-subject" class="form-control fw-semibold fs-4" required
                        placeholder=" کلاس ایڈ کریں" />
                      <!-- <span class="error" id="std-area-err"></span> -->
                    </div>

                    <div class="col-md-12 mb-2 mt-3 ">
                      <label class="fs-5 mb-1" for="class-select">سیکشن منتخب کریں</label>
                      <select id="user-select" name="class-select"
                        ...
                        <option value="الف" class="jameel-kasheeda">الف</option>
                        <option value="ب" class="jameel-kasheeda">ب</option>
                      </select>
                      <!-- <span class="error" id="std-area-err"></span> -->
                    </div>
                    <!-- <span class="error" id="std-area-err"></span> -->
