      ...
      <div class="card-body">
        ...
        <div class="table-responsive text-center py-9">
          <table class="table align-middle text-nowrap mb-0">
            ...
            $select_user_query = "SELECT * FROM `users` INNER JOIN `user_details` ON users.user_id = user_details.user_id WHERE users.role_id = 1 OR users.role_id = 2";
            ...
            ?>
                <tbody class="border-top">
                  <tr>
                    ...
                    <td>
                      <?php
                      if ($fatch_user['role_id'] === '1') {
                        echo '<p class="mb-0 fs-4 jameel-kasheeda bg-primary text-center text-white rounded-2"> سپر ایڈمن </p>';
                      } elseif ($fatch_user['role_id'] === '2') {
                        echo '<p class="mb-0 fs-4 jameel-kasheeda bg-success  text-center text-white rounded-2">ایڈمن</p>';
                      }
                      ?>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="action-btn">
                        ...
                        if ($fatch_user['dlt_status'] !== 'غیر فعال') {
                          echo '<a href="user-edit.php?user_edit=' . $fatch_user['user_id'] . '" class="text-success"><i class="ti ti-edit fs-6"></i></a>';
                        }
                        ?>
                        <?php
                        if ($fatch_user['dlt_status'] !== 'غیر فعال') {
                          echo '<a href="user-view-profile.php?user_view_profile=' . $fatch_user['user_id'] . '" class="text-primary"><i class="ti ti-eye fs-6"></i></a>';
                        }
                        ?>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="user-all-code.php?user_delete=<?= $fatch_user['user_id'] ?>">
