          ...
          <div class="card-body">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <span class="error text-danger inter std_gender"></span>
              </div>
              <div class="col-md-6">
          ...
          <div class="card-body">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="guar_cnic" id="guar_cnic" class="form-control fw-semibold fs-3" placeholder="03186432506" />
                <span class="error text-danger inter guar_cnic"></span>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <span class="error text-danger inter guar_email"></span>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  ...
                  <span class="error text-danger inter adm_date"></span>
                </div>
              ...
              <div class="card-body">
                <div class="row g-4">
                  <div class="col-lg-6">
                    ...
                    <span class="text-danger inter studentMadarasa"></span>
                  </div>
                  ...
                  <div class="col-md-6 mb-2">
                    ...
                    <span class="error text-danger inter MadYear"></span>
                  </div>
                  ...
                  <div class="col-md-6 mb-2">
                    ...
                    <span class="error text-danger inter section"></span>
                  </div>
                  <div class="col-md-6 mb-2">
                    ...
                    <span class="error text-danger inter std_qadeem"></span>
                  </div>
                  <div class="col-md-6 mb-2">
                    ...
                    <span class="error text-danger inter admi_fees"></span>
                  </div>
                  <div class="col-md-6 mb-2">
                    ...
                    <span class="error text-danger inter monthly_fees"></span>
                  </div>
                </div>
              </div>
            </div>
