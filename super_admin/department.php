          ...
          <form method="post" id="department" action="code.php">
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <input type="text" name="department" id="departmentName" class="form-control fw-semibold fs-3 " placeholder="شعبہ کا  نام" />
                <span class="text-danger departmentName"></span>
              </div>

              <div class="col-md-12 mt-4 jameel-kasheeda">
                <button type="submit" id="submit" name="departmentBtn" class="btn btn-primary fw-semibold fs-5">ایڈ کریں</button>
              </div>
          </form>
        </div>
      </div>
