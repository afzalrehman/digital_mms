        ...
        <div class="card-body">
          <form method="post" id="admission_setting" action="code.php">
            <div class="row g-4">
              ...
              <div class="col-md-12">
                <label class="fs-5 mb-1" for="std-area"> ایڈمیشن شروع یا ختم:
                ...
                <select class="form-control fw-semibold fs-3 jameel-kasheeda" name="admission_setting" id="departmentMad">
                  <option class="jameel-kasheeda" value="">ایڈمیشن شروع یا ختم</option>
              ...
              <div class="col-md-12 mt-4 jameel-kasheeda">
                <button type="submit" id="submit" name="admission_SettingBtn" class="btn btn-primary fw-semibold fs-5">ایڈ کریں</button>
              </div>
          </form>
        </div>
      </div>
            ...
            <tbody class="border-top">
              ...
              ?>
                  <tr>
                    ...
                    ?>
                    <td>
                      <p class="mb-0 fs-4 word-spacing-2px"><?php if($item['open_close'] == 1){echo 'شروع';}else { echo 'بند';} ?></p>
                    </td>
                    <td>
                      <?php
                      if ($item['status'] === 'فعال') {
                    ...
                    <td class="text-center">
                      <div class="action-btn">
                        <a href="admission_Setting_edit.php?admission_Setting_edit=<?= $item['id'] ?>" class="text-success">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="code.php?Admission_Setting_delete=<?= $item['id'] ?>">
